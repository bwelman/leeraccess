...
```{r access-window, fig.cap="Programmavenster Access.", out.width="80%"}
...
## Nieuwe database {#intro-database-new}
...
```{r saveas, fig.cap="Dialoogvenster Opslaan als", out.width="80%"}
