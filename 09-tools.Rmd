...
In de afbeelding hierna is een voorbeeld van een tabel [Contacts]{.varname} te zien. Hierin is te zien dat veel gegevens meervoudig worden opgeslagen. Deze tabel is niet dus niet genormaliseerd. Access kan deze tabel splitsen in twee tabellen zo dat zo min mogelijk gegevens meervoudig worden opgeslagen.
...
12. Selecteer [Geen query maken]{.uicontrol} en klik op [Voltooien]{.uicontrol}. Er zijn nu drie tabellen: [Contacts]{.varname} (oorspronkelijke tabel), [Contactpersons]{.varname} (nieuwe tabel), [Tabel1]{.varname} (nieuwe tabel)
