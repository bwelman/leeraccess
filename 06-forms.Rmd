...
```{r f-customers-orders-1, fig.cap="Hoofdformulier Klanten met subformulier Orders.", out.width="60%"}
...
```{r f-stock-in-trade-design, fig.cap="Ontwerpweergave formulier inventaris.", out.width="70%"}
...
```{r f-boxes-subform, fig.cap="Keuzelijst op subformulier dozen.", out.width="70%"}
...
```{r q-orderdetails-boxes-design, fig.cap="Ontwerp query orderdetails dozen.", out.width="70%"}
...
```{r f-orderdatasub-properties, fig.cap="Standaardweergave subformulier.", out.width="70%"}
...
```{r q-sales-box-month-design, fig.cap="Ontwerp query omzet", out.width="80%"}
...
```{r chartwizard-layout-default, fig.cap="Voorstel indeling grafiek.", out.width="70%"}
...
```{r chartwizard-layout-data, fig.cap="Definitieve indeling grafiek.", out.width="70%"}
...
```{r chartwizard-linking-fields, fig.cap="Koppeling tussen velden formulier en grafiek.", out.width="70%"}
...
```{r f-wizard-t-customers-2, fig.cap="Wizard Formulier keuze velden.", out.width="70%"}
knitr::include_graphics("images/forms/f-wizard-t-customers.png")
```
...
```{r f-wizard-customerorders-dataview, fig.cap="Wizard gekoppelde formulieren.", out.width="70%"}
