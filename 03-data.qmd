...
Met het formulier [Inschrijving]{.varname} kunnen alleen nieuwe records worden toegevoegd aan de tabel [Klanten]{.varname}. Bladeren door de bestaande records is uitgeschakeld.
...
Met het formulier [Bonbons]{.varname} kun je zowel door bestaande records bladeren als nieuwe records toevoegen.
...
Een nieuwe doos kun je toevoegen met het formulier [Dozen]{.varname}. Dit formulier wijkt af van de voorgaande twee, doordat er een ander formulier in is opgenomen. Deze constructie wordt een hoofdformulier met een subformulier genoemd.

Hoofdformulier ([Dozen]{.varname})

:   Dit formulier bevat gegevens over de doos zelf (niet over de inhoud) zoals [doosnaam]{.varname}, [dooscode]{.varname}, [doosbeschrijving]{.varname}, [gewicht]{.varname}, [doosprijs]{.varname} en de [magazijnvoorraad]{.varname}. Deze gegevens worden opgeslagen in de tabel [Dozen]{.varname}.

Subformulier ([Dozen subformulier]{.varname})

:   Dit formulier bevat gegevens over de bonbons in de doos, zoals [Bonboncode]{.varname} en [Hoeveelheid]{.varname}. Deze gegevens worden opgeslagen in de tabel [Doosdetails]{.varname}.

::: callout-note
De inhoud van het veld [Dooskosten]{.varname} wordt berekend via de som van `Bonbonkosten * Hoeveelheid` voor alle bonbons in de doos. Omdat je deze waarde kunt berekenen, wordt deze niet in een tabel opgeslagen.
:::
