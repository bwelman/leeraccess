...
-   mag niet de volgende tekens bevatten: punt, uitroepteken en blokhaken (\[ \]).
...
::: callout-important
**Consequenties referentiële integriteit**
...
-   Je kunt een record niet uit de primaire tabel verwijderen als er gerelateerde records bestaan in andere tabellen. Zo kun je geen record uit de tabel [Klanten]{.varname} verwijderen als er in de tabel [Orders]{.varname} nog records voor deze klant bestaan.

-   Je kunt de waarde van de primaire-sleutel in de primaire tabel niet wijzigen wanneer er gerelateerde records bestaan in andere tabellen. Zo kun je de klantcode in de tabel [Klanten]{.varname} niet wijzigen als er records in de tabel [Orders]{.varname} aan deze klant zijn toegewezen.
:::
...
Wanneer de tabel [Werknemers]{.varname} beschikbaar is (gemaakt in @exr-tabl008), neem dan bij de registratie van het contactmoment ook op door welke werknemer de registratie is afgehandeld. Hiervoor moet je de tabel [Contacten]{.varname} koppelen met de tabel [Werknemers]{.varname}.
:::
