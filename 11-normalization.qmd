...
De attributen die vaker dan één keer voorkomen worden ook wel een **Repeterende Groep (Repeating Group)** genoemd, afgekort als **RG**. Omdat op de factuur meerdere factuurregels met artikelen voorkomen vormen de attributen [Artikelnr]{.varname}, [Artikelomschrijving]{.varname}, [Aantal]{.varname} en [Prijs]{.varname} een RG. Het is als voorbereiding op de volgende stap handig om een RG in de lijst aan te duiden.
...
![Relaties weergegeven in Microsoft Access](images/normalization/example-relations.png){#fig-example-relations}
...
![Behandelingen dieren.](images/normalization/animal-clinic-table.png){#fig-animal-clinic-table}
