...
```{r label-wizard-avery7160, fig.cap="Keuze etikettype Avery L7160.", out.width="60%"}
...
```{r label-wizard-fields, fig.cap="Gegevens op het etiket.", out.width="60%"}
...
```{r report-customers-printpreview, fig.cap="Afdrukvoorbeeld.", out.width="60%"}
...
```{r group-wizard-fields, fig.cap="Selecteer de op te nemen velden.", out.width="60%"}
...
```{r group-wizard-levels, fig.cap="Selecteer de velden waarop gegroepeerd moet worden.", out.width="60%"}
...
```{r group-wizard-sort, fig.cap="Sorteervelden en opties voor totalen specificeren.", out.width="60%"}
...
```{r group-wizard-layout, fig.cap="Opmaak van het rapport aangeven.", out.width="60%"}
...
```{r label-wizard-zweckform3415, fig.cap="Keuze etikettype Zweckform 3415.", out.width="60%"}
...
```{r report-pralines-result, fig.cap="Afdrukvoorbeeld bonbonsoorten.", out.width="75%"}
