...
```{r word-mailmerge-wizard, fig.cap="Wizard Afdruk samenvoegen.", out.width="60%"}
...
```{r mailmerge_wizard_step3, fig.cap="Voortgang wizard samenvoegen: stap 3 van 6.", out.width="50%"}
