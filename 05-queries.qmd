...
2.  Kies [tab Maken \> Queryontwerp (groep Query's)]{.uicontrol}. Access maakt een nieuw leeg queryvenster en toont aan de rechterkant het dialoogvenster ***Tabellen toevoegen***.

![Dialoogvenster Tabellen toevoegen](images/queries/q-show-table.png){#fig-q-show-table}

3.  Selecteer de tabel [Klanten]{.varname} en klik op [Geselecteerde tabellen toevoegen]{.uicontrol}. De tabel [Klanten]{.varname} is nu aan het queryvenster toegevoegd.
...
2.  Kies [tab Maken \> Queryontwerp (groep Query's)]{.uicontrol}. Access maakt een nieuw leeg queryvenster en toont het dialoogvenster ***Tabellen toevoegen*** (zie eventueel @fig-q-show-table).
...
3.  Voeg de tabellen [Klanten]{.varname} en [Orders]{.varname} aan het queryvenster toe.
...
3.  Voeg de tabellen [Orders]{.varname} en [Orderdetails]{.varname} aan het queryvenster toe.
...
3.  Voeg de tabel [Bonbons]{.varname} aan het queryvenster toe.
...
3.  Voeg de tabel [Klanten]{.varname} aan het queryvenster toe.
...
9.  Klik op [Queryontwerp \> Tabel maken (groep Querytype)]{.uicontrol}. Het dialoogvenster ***Tabel maken*** wordt geopend.
...
`r hide("Tip")` Het veld [Provincie]{.varname} mag hier twee waarden hebben `FR` of `GR`. Dat kun je voor elkaar krijgen door in de regel voor [Criteria]{.uicontrol} de ene waarde te vermelden en bij de regel met [Of]{.uicontrol} de andere waarde.

Een andere mogelijkheid is het gebruik van een expressie met de Of operator als criterium. `r unhide()`

`r hide("Antwoord")` Resultaat query: 40 klanten `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Resultaat query: 4 klanten `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Resultaat query: 4 dozen `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Resultaat query: 18 bonbons `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Resultaat query: 12 klanten `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Resultaat query: 3 klanten `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Tip")` Zoek eerst uit welke waarde het veld Vullingtype heeft als een bonbon geen vulling heeft. `r unhide()`

`r hide("Antwoord")` Resultaat query: 12 bonbons `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Tip")` Zoek eerst uit welke expressie je in een criterium moet gebruiken voor “niet gelijk aan”. `r unhide()`

`r hide("Antwoord")` Resultaat query: 293 klanten `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/queries/quer009-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/queries/quer010-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/queries/quer011-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/queries/quer012-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Resultaat query: 264 klanten `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/queries/quer014-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` Resultaat query: 22 bonbons
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/queries/quer016-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/queries/quer017-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/queries/quer018-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Tip")` Dezelfde klant kan vaker dan 1 keer in het overzicht voorkomen. Om dit te vermijden moet bij de eigenschappen van de query de waarde van de eigenschap Unieke records op Ja ingesteld worden. De eigenschappen van de query kunnen zichtbaar gemaakt worden in de Ontwerpweergave van de query het venster Eigenschappen zichtbaar te maken en daarna in het rechterbovengebied van het ontwerpvenster op een lege plek te klikken. `r unhide()`

`r hide("Antwoord")` ![](images/queries/quer019-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/queries/quer020-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/queries/quer021-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Tip")` Dezelfde klant kan vaker dan 1 keer in het overzicht voorkomen. Om dit te vermijden moet bij de eigenschappen van de query de waarde van de eigenschap Unieke waarden op Ja ingesteld worden. `r unhide()`

`r hide("Antwoord")` ![](images/queries/quer023-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/queries/quer024-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/queries/quer027-result.png) `r unhide()`
:::
::::
...
::: {.content-visible when-format="html:js"}
`r hide("Antwoord")` ![](images/queries/quer029-result.png) `r unhide()`
:::
::::
